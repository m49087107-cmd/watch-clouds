...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black relative">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=2025')] bg-cover bg-center opacity-20 pointer-events-none" />
      ...
      <div className="w-full max-w-md p-8 md:p-10 rounded-2xl bg-card/40 backdrop-blur-xl border border-white/10 relative z-10 shadow-2xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-serif font-bold text-white tracking-wide">Join the Club</h1>
          <p className="text-white/50 text-sm mt-2">Create your Watch Clouds account</p>
        </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <Button 
              type="submit" 
              className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-lg shadow-lg shadow-primary/20 transition-all hover:shadow-primary/40 text-base mt-2"
